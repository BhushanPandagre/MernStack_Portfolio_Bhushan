    ...
    <div className="flex min-h-screen w-full flex-col bg-muted/40">
      <aside className="fixed inset-y-0 left-0 hidden w-14 flex-col border-r bg-background sm:flex z-50">
        <nav className="flex flex-col items-center gap-4 px-2 sm:py-5">
          ...
          {[
            ...
            { label: "Add Project", icon: <FolderGit className="h-5 w-5" /> },
            { label: "Add Skill", icon: <PencilRuler className="h-5 w-5" /> },
            { label: "Add Uses", icon: <LayoutGrid className="h-5 w-5" /> },
            { label: "Add Timeline", icon: <History className="h-5 w-5" /> },
            { label: "Messages", icon: <MessageSquareMore className="h-5 w-5" /> },
      ...
      <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6 max-[900px]:h-[100px]">
        <Sheet>
          ...
          <SheetContent side="left" className="sm:max-w-xs">
            <nav className="grid gap-6 text-lg font-medium">
              <Link className="group flex h-10 w-10 items-center justify-center gap-2 rounded-full bg-primary text-lg font-semibold text-primary-foreground md:text-base">
                <Package2 className="h-5 w-5 transition-all group-hover:scale-110" />
                <span className="sr-only">Acme Inc</span>
              </Link>
              ...
              {[
                ...
                { label: "Add Uses", icon: <LayoutGrid className="h-5 w-5" /> },
                { label: "Account", icon: <User className="h-5 w-5" /> },
                { label: "Timeline", icon: <History className="h-5 w-5" /> },
                { label: "Messages", icon: <MessageSquareMore className="h-5 w-5" /> },
              ].map((item) => (
                <Link
                  key={item.label}
